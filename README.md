...
- [OpenAI](https://openai.com)'s **Codex** picked the flag back up once this same repo helped restore usable Codex limits — adding safe referral invite diagnostics, cookie-assisted eligibility probes, and the guardrails that keep status checks from sending real invites. A small full-circle moment.
